...
- Миграциите се прилагат само от `supabase/migrations/` (не от `drizzle/`). Последната е `20260924141919_catalog_templates_discount`.
...
- Имейлите вече са доста. Провери лимита на плана в Resend (безплатният е 100 на ден).
