  ...
  return (
    ...
    >
      <div className="sticky top-0 h-screen overflow-hidden supports-[height:100svh]:h-svh">
        ...
        <div className="absolute left-[6vw] right-[6vw] top-24 z-20 flex max-md:top-[92px] items-center justify-between font-mono text-[9px] tracking-[0.16em] text-[#c6dfdf]">
          <span>LIVE CHANGE RECORD</span>
          <span>MF / 0042 / SOFIA</span>
        </div>

        <div className="relative z-10 mx-auto grid h-full max-w-[1500px] items-center gap-10 px-[6vw] max-md:flex max-md:flex-col max-md:items-stretch max-md:gap-5 max-md:pb-[calc(4svh+44px)] max-md:pt-[124px] lg:grid-cols-[0.9fr_1.1fr]">
          <div className="relative h-[52vh] max-md:h-[clamp(236px,36svh,290px)] max-md:shrink-0">
        ...
        <div className="absolute bottom-7 left-[6vw] z-20 flex items-center max-md:hidden gap-3 font-mono text-[8px] tracking-[0.14em] text-[#c6dfdf]">
