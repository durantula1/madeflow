export const workspacePageCopy = {
  ...
  clients: {
    eyebrow: "Хората, за които работиш",
    title: "Клиенти",
    description: "Всеки клиент с неговите обекти. Един човек може да има няколко обекта.",
  },
  offers: {
    eyebrow: "Предложения към клиента",
    title: "Оферти",
  ...
  newOffer: {
    title: "Нова оферта",
    description:
      "Попълваш услугите и материалите, преглеждаш сумата и чак тогава я създаваш.",
  },
  newChange: {
