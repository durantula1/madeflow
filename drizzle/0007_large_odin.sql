CREATE TYPE "app"."document_kind" AS ENUM('offer', 'change');--> statement-breakpoint
...
--> statement-breakpoint
DROP INDEX "app"."change_orders_project_sequence_uidx";--> statement-breakpoint
...
ALTER TABLE "app"."change_orders" ADD COLUMN "document_kind" "app"."document_kind" DEFAULT 'change' NOT NULL;--> statement-breakpoint
ALTER TABLE "app"."change_orders" ADD COLUMN "baseline_offer_id" uuid;--> statement-breakpoint
...
ALTER TABLE "app"."change_orders" ADD CONSTRAINT "change_orders_baseline_offer_id_change_orders_id_fk" FOREIGN KEY ("baseline_offer_id") REFERENCES "app"."change_orders"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "change_orders_project_kind_sequence_uidx" ON "app"."change_orders" USING btree ("project_id","document_kind","sequence_number");--> statement-breakpoint
